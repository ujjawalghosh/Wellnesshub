...
const newFeatures = [
  { path: '/water', icon: Droplets, label: 'Water Tracker', color: 'text-blue-400' },
  { path: '/sleep', icon: Moon, label: 'Sleep Tracker', color: 'text-indigo-400' },
  { path: '/mood', icon: Smile, label: 'Mood Tracker', color: 'text-yellow-400' },
  { path: '/pomodoro', icon: Timer, label: 'Pomodoro', color: 'text-red-400' },
  { path: '/affirmations', icon: Sparkles, label: 'Affirmations', color: 'text-amber-400' },
]
    ...
    >
      ...
      <nav className="p-4 space-y-2 overflow-y-auto max-h-[calc(100vh-180px)]">
        ...
        <div className="pt-4 pb-2">
          <span className="text-xs text-slate-500 uppercase tracking-wider px-4">New Features</span>
        </div>
