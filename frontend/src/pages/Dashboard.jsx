...
export default function Dashboard() {
  ...
  const newFeatures = [
    { icon: Droplets, label: 'Water', path: '/water', color: 'bg-blue-500' },
    { icon: Moon, label: 'Sleep', path: '/sleep', color: 'bg-indigo-500' },
    { icon: Smile, label: 'Mood', path: '/mood', color: 'bg-yellow-500' },
    { icon: Timer, label: 'Pomodoro', path: '/pomodoro', color: 'bg-red-500' }
  ]
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/affirmations" className="text-primary text-sm flex items-center gap-1">
            View All <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
